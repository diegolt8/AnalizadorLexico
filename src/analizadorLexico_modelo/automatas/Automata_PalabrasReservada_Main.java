 ...
 * @author Pepe
 */
public class Automata_PalabrasReservada_Main implements Automata {
    ...
    public Lexema estado_qf(String lexema, int fila, int columna) {        
        return new Lexema(lexema, TipoLexemaEnum.PR_MAIN, fila, columna, lexema.length());
    }
}
