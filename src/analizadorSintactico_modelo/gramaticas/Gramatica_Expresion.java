...
public class Gramatica_Expresion implements Gramatica {
    ...
    public Sentencia analizar(FlujoLexema flujoLexema) {
        ...
        if (flujoLexema.getLexema().getTipoLexema() == TipoLexemaEnum.VALOR_NUMERICO) {
            ...
            if (flujoLexema.getLexema().getTipoLexema() == TipoLexemaEnum.PUNTO) {
                ...
                if (flujoLexema.getLexema().getTipoLexema() == TipoLexemaEnum.VALOR_NUMERICO) {
                    ...
                    if (flujoLexema.getLexema().getTipoLexema() == TipoLexemaEnum.COMA || flujoLexema.getLexema().getTipoLexema() == TipoLexemaEnum.PUNTO_Y_COMA
                            || flujoLexema.getLexema().getTipoLexema() == TipoLexemaEnum.PARENTESIS_CERRADO) {
            ...
            } else if (flujoLexema.getLexema().getTipoLexema() == TipoLexemaEnum.COMA || flujoLexema.getLexema().getTipoLexema() == TipoLexemaEnum.PUNTO_Y_COMA
                    || flujoLexema.getLexema().getTipoLexema() == TipoLexemaEnum.PARENTESIS_CERRADO) {
                flujoLexema.setPosActual(posicion);
                TerminoLiteral terminoLiteral = (TerminoLiteral) gramaticaTerminoLiteral.analizar(flujoLexema);
                if (terminoLiteral != null) {
    ...
    if (expresionNumerica

    
        != null) {
            if (flujoLexema.getLexema().getTipoLexema() == TipoLexemaEnum.PUNTO_Y_COMA || flujoLexema.getLexema().getTipoLexema() == TipoLexemaEnum.COMA) {
