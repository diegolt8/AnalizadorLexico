 ...
 * @author vi74ly
 */
public class Gramatica_ParaTest {

    public Gramatica_ParaTest() {
    }
    ...
    /**
     * Test of analizar method, of class Gramatica_Para.
     */
    @Test
    public void testAnalizarValida() {
        System.out.println("analizar");
        ArrayList<Lexema> lexema = new ArrayList<>();
        lexema.add(new Lexema("Para", TipoLexemaEnum.EST_PARA, 0, 0, 0));
        ...
        lexema.add(new Lexema(";", TipoLexemaEnum.PUNTO_Y_COMA, 0, 0, 0));
        lexema.add(new Lexema("a", TipoLexemaEnum.IDENTIFICADOR, 0, 0, 0));
        lexema.add(new Lexema("++", TipoLexemaEnum.OPE_ESP_SUMA, 0, 0, 0));
        ...
        Gramatica_Para instance = new Gramatica_Para();
