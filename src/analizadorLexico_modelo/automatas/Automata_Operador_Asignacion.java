...
public class Automata_Operador_Asignacion implements Automata {
    ...
    public Lexema estado_qf(String lexema, int fila, int columna) {
        ...
        switch (lexema){
            case "+=":
                tipoLexema = TipoLexemaEnum.OPE_ASIG_SUMA;
                break;
            case "-=":
                tipoLexema = TipoLexemaEnum.OPE_ASIG_RESTA;
                break;            
            case "*=":
                tipoLexema = TipoLexemaEnum.OPE_ASIG_MULTIPLICACION;
                break;
            case "/=":
                tipoLexema = TipoLexemaEnum.OPE_ASIG_DIVISION;
                break;
            case "=":
                tipoLexema = TipoLexemaEnum.OPE_ASIG_IGUAL;
                break;
        }
