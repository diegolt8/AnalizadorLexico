 ...
 * @author vi74ly
 */
public class Gramatica_SiTest {
    
    public Gramatica_SiTest() {
    }
    ...
    /**
     * Test of analizar method, of class Gramatica_Si.
     */
    @Test
    public void testAnalizar() {
        System.out.println("analizar");
        ArrayList<Lexema> lexema = new ArrayList<>();
        lexema.add(new Lexema("Si", TipoLexemaEnum.EST_SI, 0, 0, 0));
        ...
        Gramatica_Si instance = new Gramatica_Si();
