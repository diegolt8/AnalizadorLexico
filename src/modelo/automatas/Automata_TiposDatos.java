...
public class Automata_TiposDatos implements Automata{
    ...
    private String estado_q7(char caracter){
        return (caracter == 'r' || caracter == 'd') ? "qf" : "q7";
    }
