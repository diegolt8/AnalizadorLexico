 ...
 * @author vi74ly
 */
public class Gramatica_DeclaracionVariableTest {

    public Gramatica_DeclaracionVariableTest() {
    }
    ...
    /**
     * Test of analizar method, of class Gramatica_DeclaracionVariable.
     */
    @Test
    public void testAnalizarValida() {
        System.out.println("---analizar prueba valida---");
        ArrayList<Lexema> lexema = new ArrayList<>();
        lexema.add(new Lexema("Car", TipoLexemaEnum.TIPO_DATO_CAR, 0, 0, 0));
        ...
        Gramatica_DeclaracionVariable instance = new Gramatica_DeclaracionVariable();
