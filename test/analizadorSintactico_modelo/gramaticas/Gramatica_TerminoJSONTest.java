 ...
 * @author vi74ly
 */
public class Gramatica_TerminoJSONTest {
    
    public Gramatica_TerminoJSONTest() {
    }
    ...
    /**
     * Test of analizar method, of class Gramatica_TerminoJSON.
     */
    @Test
    public void testAnalizarValida() {
        ...
        lexema.add(new Lexema(":", TipoLexemaEnum.DOS_PUNTOS, 0, 0, 0));
        lexema.add(new Lexema("'a'", TipoLexemaEnum.VALOR_CADENA, 0, 0, 0));
        lexema.add(new Lexema(";", TipoLexemaEnum.PUNTO_Y_COMA, 0, 0, 0));
        FlujoLexema flujoLexema = new FlujoLexema(lexema);
        Gramatica_TerminoJSON instance = new Gramatica_TerminoJSON();
