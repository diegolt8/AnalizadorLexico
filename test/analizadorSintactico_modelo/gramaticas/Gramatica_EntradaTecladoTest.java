 ...
 * @author vi74ly
 */
public class Gramatica_EntradaTecladoTest {
    
    public Gramatica_EntradaTecladoTest() {
    }
    ...
    /**
     * Test of analizar method, of class Gramatica_EntradaTeclado.
     */
    @Test
    public void testAnalizar() {
        System.out.println("analizar");
        ArrayList<Lexema> lexema = new ArrayList<>();
        lexema.add(new Lexema("Entr", TipoLexemaEnum.STR_ENTR, 0, 0, 0));
        ...
        Gramatica_EntradaTeclado instance = new Gramatica_EntradaTeclado();
