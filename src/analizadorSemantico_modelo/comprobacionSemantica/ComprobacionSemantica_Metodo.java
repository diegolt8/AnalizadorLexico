 ...
 * @author Pepe
 */
public class ComprobacionSemantica_Metodo implements ComprobacionSemantica{
    ...
    public boolean comprobacionSemantica(FlujoSentencias flujoSentencia) {
        ...
        Metodo metodo = (Metodo) flujoSentencia.getNodoActual();
        ListaSentencias<Sentencia> listaSentencia = metodo.getListaSentencias();
        flujoSentencia.parametrosVariables(metodo.getNombreMetodo().getLexema());
