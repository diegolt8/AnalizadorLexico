 ...
 * @author vi74ly
 */
public class Gramatica_RespuestaHTTPTest {

    public Gramatica_RespuestaHTTPTest() {
    }
    ...
    /**
     * Test of analizar method, of class Gramatica_RespuestaHTTP.
     */
    @Test
    public void testAnalizarValida() {
        System.out.println("analizar");
        ArrayList<Lexema> lexema = new ArrayList<>();
        lexema.add(new Lexema("HTTP", TipoLexemaEnum.HTTP, 0, 0, 0));
        ...
        lexema.add(new Lexema("Respuesta", TipoLexemaEnum.REQUEST_RESPUESTA, 0, 0, 0));
        lexema.add(new Lexema("(", TipoLexemaEnum.PARENTESIS_ABIERTO, 0, 0, 0));
        lexema.add(new Lexema(")", TipoLexemaEnum.PARENTESIS_CERRADO, 0, 0, 0));
        lexema.add(new Lexema(";", TipoLexemaEnum.PUNTO_Y_COMA, 0, 0, 0));
        FlujoLexema flujoLexema = new FlujoLexema(lexema);
        Gramatica_RespuestaHTTP instance = new Gramatica_RespuestaHTTP();
