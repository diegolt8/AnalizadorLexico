 ...
 * @author vi74ly
 */
public class Gramatica_HTTPCrearTest {

    public Gramatica_HTTPCrearTest() {
    }
    ...
    /**
     * Test of analizar method, of class Gramatica_HTTPCrear.
     */
    @Test
    public void testAnalizarValida() {
        System.out.println("analizar");
        ArrayList<Lexema> lexema = new ArrayList<>();
        lexema.add(new Lexema("Crear", TipoLexemaEnum.VERBO_HTTP_POST, 0, 0, 0));
        ...
        Gramatica_HTTPCrear instance = new Gramatica_HTTPCrear();
