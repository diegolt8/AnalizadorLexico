 ...
 * @author Pepe
 */
public class Automata_PalabrasReservada_Bucles implements Automata {
    ...
    public Lexema estado_qf(String lexema, int fila, int columna) {
        ...
        switch (lexema){
            case "Retorno":
                tipoLexema = TipoLexemaEnum.VLR_RETORNO;
                break;
            case "Romper":
                tipoLexema = TipoLexemaEnum.VLR_ROMPER;
                break;            
            case "Continuar":
                tipoLexema = TipoLexemaEnum.VLR_CONTINUAR;
                break;
        }
