 ...
 * @author vi74ly
 */
public class Gramatica_BloqueSentenciasTest {

    public Gramatica_BloqueSentenciasTest() {
    }
    ...
    /**
     * Test of analizar method, of class Gramatica_BloqueSentencias.
     */
    @Test
    public void testAnalizarValido() {
        ...
        lexema.add(new Lexema("\"", TipoLexemaEnum.COMILLA_DOBLE, 0, 0, 0));
        Gramatica_BloqueSentencias instance = new Gramatica_BloqueSentencias();
