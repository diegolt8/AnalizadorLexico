 ...
 * @author vi74ly
 */
public class Gramatica_ExpresionTest {
    
    public Gramatica_ExpresionTest() {
    }
    ...
    /**
     * Test of analizar method, of class Gramatica_Expresion.
     */
    @Test
    public void testAnalizarValido() {
        System.out.println("analizar");
        ArrayList<Lexema> lexema = new ArrayList<>();
        lexema.add(new Lexema("NULO", TipoLexemaEnum.VLR_NULO, 0, 0, 0));
        FlujoLexema flujoLexema = new FlujoLexema(lexema);
        Gramatica_Expresion instance = new Gramatica_Expresion();
