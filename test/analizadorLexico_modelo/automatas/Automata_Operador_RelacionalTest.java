...
import analizadorLexico_modelo.automatas.Automata_Operador_Relacional;
 ...
 * @author Pepe
 */
public class Automata_Operador_RelacionalTest {
    
    public Automata_Operador_RelacionalTest() {
    }
    ...
    public void testEjecutarAutomataValido() {
        ...
        Automata_Operador_Relacional instance = new Automata_Operador_Relacional();
