 ...
 * @author vi74ly
 */
public class Gramatica_InicializadorVariableTest {

    public Gramatica_InicializadorVariableTest() {
    }
    ...
    /**
     * Test of analizar method, of class Gramatica_InicializadorVariable.
     */
    @Test
    public void testAnalizarValido() {
        ...
        Gramatica_InicializadorVariable instance = new Gramatica_InicializadorVariable();
